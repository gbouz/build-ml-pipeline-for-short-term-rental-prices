...
*The project is documented in both **github** and **wandb** in the following links:*

- *https://github.com/gbouz/build-ml-pipeline-for-short-term-rental-prices*
- *https://wandb.ai/gbouz/nyc_airbnb/overview*
